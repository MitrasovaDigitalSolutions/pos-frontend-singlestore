...
import { useForm, FormProvider, useWatch, type Resolver, type FieldErrors } from "react-hook-form";
        ...
        if (open) {
            if (editingProduct) {
                reset({
                    ...
                    merek: editingProduct.brand?.nama || editingProduct.merek || "",
                    barcode: editingProduct.barcode || "",
                    harga: Number(editingProduct.harga || 0),
                    stok: Number(editingProduct.stok || 0),
                    harga_beli: editingProduct.harga_beli ? Number(editingProduct.harga_beli) : null,
                    margin: editingProduct.margin ? Number(editingProduct.margin) : null,
                    category_uid: editingProduct.category_uid || null,
                    brand_uid: editingProduct.brand_uid || null,
                    image: undefined,
                    is_jasa: Boolean(editingProduct.is_jasa),
                });
            } else {
